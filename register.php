                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="text"  name="firstname" class="form-control form-control-user" id="exampleFirstName"
                                            ...
                                            <?php
                                       if (isset($_SESSION['error']["firstname_error"])) {
                                        ?>
                                           <span class="text-danger"><?=$_SESSION['error']["firstname_error"] ?></span>
                                           <?php
                                       }
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" name="lastname" class="form-control form-control-user" id="exampleLastName"
                                            placeholder="Last Name" >
                                             <?php
                                       if (isset($_SESSION['error']["lastname_error"])) {
                                        ?>
                                           <span class="text-danger"><?=$_SESSION['error']["lastname_error"] ?></span>
                                           <?php
                                       }
                                ...
                                <div class="form-group">
                                    <input type="text"  name="email" class="form-control form-control-user" id="exampleInputEmail"
                                       ...
                                       if (isset($_SESSION['error']["email_error"])) {
                                        ?>
                                           <span class="text-danger"><?=$_SESSION['error']["email_error"] ?></span>
                                           <?php
                                       }
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                       ...
                                       if (isset($_SESSION['error']["password_error"])) {
                                        ?>
                                           <span class="text-danger"><?=$_SESSION['error']["password_error"] ?></span>
                                           <?php
                                       }
                                    ...
                                    <div class="col-sm-6">
                                       ...
                                       if (isset($_SESSION['error']["confirm_password_error"])) {
                                        ?>
                                           <span class="text-danger"><?=$_SESSION['error']["confirm_password_error"] ?></span>
                                           <?php
                                       }
